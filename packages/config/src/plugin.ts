...
export type PluginsInput = readonly VelaPlugin[] | ResolvedPlugins;
...
export function runPlugins(
	...
	const resolved: ResolvedPlugins = { utilities: { ...base.utilities } };
	...
	if (!Array.isArray(plugins)) {
		const stated = plugins as ResolvedPlugins;
